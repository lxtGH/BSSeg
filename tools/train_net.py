...
from cvpods.evaluation import (  # isort:skip
    CityPersonsEvaluator, CityscapesInstanceEvaluator, CityscapesSemSegEvaluator,
...
def stage_main(args, cfg, build):
    ...
    if args.eval_only:
        DetectionCheckpointer(
            trainer.model, save_dir=cfg.OUTPUT_DIR, resume=args.resume, replace_substr_dict=cfg.MODEL.REPLACE_SUBSTR_DICT).resume_or_load(
