...
class Checkpointer(object):
    ...
    def _load_model(self, checkpoint: Any, replace_substr_dict={}):
        """
        ...
        new_checkpoint_state_dict = dict()
        for key, weights in checkpoint_state_dict.items():
            new_checkpoint_state_dict[key] = weights
            for k, v in replace_substr_dict.items():
                if k in key:
                    new_checkpoint_state_dict[v] = weights
                    print("load extra keys", v, "in origin model: ", k)
