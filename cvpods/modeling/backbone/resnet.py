...
from cvpods.layers import (
    ...
    ModulatedDeformConv, ShapeSpec, get_norm, CNNBlockBase
)
...
def build_resnet_deeplab_backbone(cfg, input_shape):
    """
    Create a ResNet instance from config for deeplabv3_r50 backbone
    Returns:
        ResNet: a :class:`ResNet` instance.
    """
    # need registration of new blocks/stems?
    ...
    elif cfg.MODEL.RESNETS.STEM_TYPE == "deeplabv3_r50":
        stem = DeepLabStem(
            in_channels=input_shape.channels,
            out_channels=cfg.MODEL.RESNETS.STEM_OUT_CHANNELS,
            norm=norm,
