...
from cvpods.modeling.meta_arch.retinanet.retinanet import permute_to_N_HWA_K
...
from cvpods.layers.dynamic_conv import DynamicBottleneck, DynamicScale
...
class FCOSSEPC(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.head = FCOSSEPCHead(cfg, feature_shapes)
    ...
    def forward(self, batched_inputs):
        ...
        backbone_features = [features[f] for f in self.in_features]
        shifts = self.shift_generator(backbone_features)
...
class FCOSSEPCHead(nn.Module):
    ...
    def forward(self, features):
        ...
        for level, feature in enumerate(features):
            cls_subnet = feature[0]
            bbox_subnet = feature[1]
