...
from cvpods.layers import (ShapeSpec, SwapAlign2Nat, generalized_batched_nms, cat,
...
from cvpods.modeling.meta_arch.retinanet.retinanet import (
    permute_all_cls_and_box_to_N_HWA_K_and_concat, permute_to_N_HWA_K)
