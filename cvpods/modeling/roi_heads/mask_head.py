...
def mask_rcnn_loss(pred_mask_logits, instances, return_for_mask_scoring=False):
    """
    ...
    if return_for_mask_scoring:
        return mask_loss, gt_masks_bool, pred_mask_logits
    else:
        return mask_loss


def mask_rcnn_inference(pred_mask_logits, pred_instances, return_for_mask_scoring=False):
    """
