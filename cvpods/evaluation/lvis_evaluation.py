...
class LVISEvaluator(DatasetEvaluator):
    ...
    def _eval_predictions(self, tasks):
        ...
        # LVIS evaluator can be used to evaluate results for COCO datasets categories.
        ...
        for task in sorted(tasks):
            ...
            res = self._derive_lvis_results(lvis_eval, task)
    ...
    def _derive_lvis_results(self, lvis_eval, iou_type):
        """
...
def _dump_to_markdown(dump_infos, md_file="README.md"):
    ...
    with open(md_file, "w") as f:
        ...
        for dump_info_per_task in dump_infos:
            ...
            lvis_eval = dump_info_per_task["lvis_eval"]
